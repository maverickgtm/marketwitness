...
<body>
  <header>
    <div class="top"><nav><a href="/dashboard/open">Open Edition</a> / <a href="/dashboard/ipo">IPO Watch Center</a> / Global Listings Watch</nav><a class="back" href="/dashboard/open">Back to terminal</a></div>
    <section class="hero">
