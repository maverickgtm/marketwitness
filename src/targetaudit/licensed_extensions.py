...
def build_licensed_extensions_snapshot(
    ...
    return {
        ...
        "policy_note": (
            ...
            "TargetAudit does not bundle restricted rows or publish shared real "
...
<title>TargetAudit | Licensed Extensions</title><style>
...
</style></head><body><header><nav>TargetAudit / Licensed Extensions</nav><h1>Bring your own<br>licensed data.</h1>
...
<main><p class="notice">A paid individual subscription can support private research only when its terms allow it. It does not enable TargetAudit to publish a shared leaderboard of real analyst results.</p><h2>Optional Providers</h2><div class="table-wrap"><table><thead><tr><th>Provider</th><th>Listed Price</th><th>Coverage</th><th>Public Output</th><th>Official Links</th></tr></thead><tbody>{rows}</tbody></table></div></main></body></html>"""
