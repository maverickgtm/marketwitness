...
<title>MarketWitness | Provider Approval Queue</title><style>
...
</style></head><body><header><nav>MarketWitness / Governance / Provider Approvals</nav><h1>Permission before<br>production data.</h1>
