...
<title>MarketWitness | Scorecard Readiness</title><style>
...
</style></head><body><header><nav>MarketWitness / Financials / Readiness</nav><h1>Earn the right<br>to publish.</h1>
