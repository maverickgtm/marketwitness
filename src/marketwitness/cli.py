...
def main() -> int:
    ...
    sec_parser.add_argument(
        "--user-agent",
        required=False,
        help='Declared SEC user agent, for example "MarketWitness contact@example.com".',
    )
    ...
    discover_parser.add_argument(
        "--user-agent",
        help="SEC contact user agent; alternatively set MARKETWITNESS_SEC_USER_AGENT.",
    )
    discover_parser.add_argument(
        "--index-file",
    ...
    prices_parser.add_argument(
        "--api-key",
        help="Alpha Vantage key; prefer MARKETWITNESS_ALPHA_VANTAGE_API_KEY or private file.",
    )
    ...
    edinet_parser.add_argument(
        "--api-key", help="EDINET subscription key; defaults to MARKETWITNESS_EDINET_API_KEY."
    )
    edinet_parser.add_argument(
        "--filing-date",
    ...
    opendart_parser.add_argument(
        "--api-key", help="OpenDART authentication key; defaults to MARKETWITNESS_OPENDART_API_KEY."
    )
    opendart_parser.add_argument(
        "--since",
        required=True,
