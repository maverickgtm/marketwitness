...
<title>MarketWitness | SEC IPO Discovery Queue</title><style>
...
</style></head><body><header><nav><a href="/dashboard/reports">Report Center</a> / <a href="/dashboard/ipo">IPO Watch Center</a> / SEC Discovery</nav>
