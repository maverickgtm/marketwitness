...
def _normalize_nport_xml_document(
    ...
    issuer = "MarketWitness Synthetic N-PORT Fixture" if synthetic_fixture else registrant
...
def render_import_report(imported: SecNportImport) -> str:
    return "\n".join(
        [
            ...
            "",
            "MarketWitness normalizes only positions reported in share units for this",
