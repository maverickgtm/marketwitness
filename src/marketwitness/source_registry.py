...
<title>MarketWitness | Source Governance</title><style>
...
</style></head><body><header><nav>MarketWitness / Governance / Sources</nav>
<h1>Open code.<br>Controlled data.</h1><p class="lead">A registry of the providers considered by MarketWitness, showing what is connected and what still requires terms or license review before public use.</p>
