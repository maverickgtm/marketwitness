...
<title>MarketWitness | Corporate Actions Audit</title><style>
...
</style></head><body><header><nav><a href="/dashboard/reports">Report Center</a> / <a href="/dashboard/financials-evidence">Financials Evidence Center</a> / Corporate Actions</nav>
...
<main><p class="notice">Affected observations are excluded from scored evaluation when this registry is supplied. MarketWitness flags the conflict; it does not invent a split-adjusted target or assume symbol continuity.</p>
