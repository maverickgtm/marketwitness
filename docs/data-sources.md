...
| Japon / Tokio | FSA `EDINET` Documents API y JPX `New Listings` | Documentos de ofertas mas fechas oficiales de aprobacion/listing TSE | Monitor JPX y diff diario implementados; EDINET pendiente como alerta documental temprana |
