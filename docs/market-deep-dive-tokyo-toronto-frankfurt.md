...
outline oficial y alimenta el diff diario. La etapa `EDINET` esta
...
fixture sintética en la demo. Sus documentos alimentan el diff diario como
evidencia regulatoria separada, nunca como confirmacion de listing.
