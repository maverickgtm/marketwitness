...
class GlobalListingsTests(unittest.TestCase):
    def test_renders_global_sources_and_priority_connectors(self) -> None:
        ...
        self.assertIn("Live official feeds: `7`", report)
        ...
        self.assertIn("2 priority; 0 planned", page)
        self.assertIn("Documented only; no ingestion", page)
        self.assertIn("HKEX, LSE, ASX, TSX, JPX, SGX and CVM have official ingestion paths", page)
