...
class SourceRegistryTests(unittest.TestCase):
    def test_renders_provider_controls_and_blocks_restricted_collection(self) -> None:
        ...
        self.assertIn("FSS OpenDART Disclosure Search API", report)
        self.assertIn("MAS OPERA Public Offers", report)
        ...
        self.assertIn("Kraken Spot REST Market Data", report)
        self.assertIn("U.S. EIA Open Data API", report)
